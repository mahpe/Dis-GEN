...
if load_json:
    ...
    with open('icsd_structure.json', 'w') as f:
        json.dump(pymatgen_list_dict, f)
    
    np.save('quary_id_icsd.npy',new_listed_dir)
...
# Save the crystal features
np.save('crystal_features_icsd_all.npy',crystal_rep.total_crystal_features)
np.save('atomic_features_icsd_all.npy',crystal_rep.total_atomistic_features)
np.save('spacegroup_icsd_all.npy',crystal_rep.spacegroup_list)
...
import pickle
with open('wyckoff_dict_icsd_all.pkl', 'wb') as f:
